...
class CatalanAffordabilityVisualizer:
    ...
    def __init__(self, spark: SparkSession, exploitation_data_path: str = "./data/exploitation", shapefile_path: str = "./geospatial/MUN_TM.shp", output_dir: str = "./data/analysis/maps"):
        """
